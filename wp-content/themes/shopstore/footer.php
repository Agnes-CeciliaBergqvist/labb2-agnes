...
?>
		...
		printf( esc_html__( 'Copyright &copy; %1$s %2$s , All Right Reserved.%3$s Shop Store Theme by %4$s - Proudly powered by %5$s', 'shopstore' ), esc_attr( date( 'Y' ) ), esc_html( get_bloginfo( 'name' ) ),'<br/>', '<a href="https://athemeart.com" target="_blank" rel="nofollow">aThemeArt</a>', '<a href="'.esc_attr( 'https://wordpress.org/themes/shopstore/' ).'" target="_blank" rel="nofollow">'.esc_html_x( 'WordPress', 'credit to cms', 'shopstore' ).'</a>' );
