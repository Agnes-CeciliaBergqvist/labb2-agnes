...
?>
		...
		<section class="footer-bottom">
			<div class="container">
                ...
                printf( esc_html__( 'Copyright &copy; %1$s %2$s. %4$s Store Commerce %3$s design & developer by aThemeArt ', 'store-commerce' ), esc_attr( date( 'Y' ) ), esc_html( get_bloginfo( 'name' ) ), '<a href="https://athemeart.com/downloads/category/wordpress/" target="_blank" rel="nofollow">WordPress theme</a>','<br/>' );
                ?></p>
